...
//         databaseReference = FirebaseDatabase.getInstance().getReference().child("Materials");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter adapter = new ArrayAdapter(BusinessSell.this, android.R.layout.simple_list_item_1, arrayList);
                myListView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(BusinessSell.this, "There was an error retrieving the data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
