...
public class BusinessProfile2 extends AppCompatActivity {

    private static final String TAG = "BusinessProfile";
    private Context mContext = BusinessProfile2.this;
...
//        setupViewPager();
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BusinessProfile2.this, BusinessBuy.class);
                startActivity(i);
            }
        });
...
//                Picasso.with(BusinessProfile2.this).load(dataSnapshot.child("image").getValue().toString())
...
//                            @Override
//                            public void onError() {
//                                Picasso.with(BusinessProfile2.this)
//                                        .load(dataSnapshot
